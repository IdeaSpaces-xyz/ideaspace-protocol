...
- [`agent-contract.md`](agent-contract.md) — the `_agent/` five-file contract, two-roles split, fractal composition, optional root identity, underscore extension rule, and a conformance checklist.
