...
- `awareness.ts` — selectable Foundation/Agreement/floor assembly, exact revisions, prompt placement, canonical rendering, and the compatibility `assembleAwareness` block; `path-context.ts` — path walking
